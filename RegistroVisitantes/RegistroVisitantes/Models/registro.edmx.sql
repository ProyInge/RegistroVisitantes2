...
-- --------------------------------------------------
-- Date Created: 10/06/2016 10:19:42
...
-- ALTER TABLE "REGISTRO"."USUARIO" DROP CONSTRAINT "FK_USUARIOV_ESTACION" CASCADE;

-- ALTER TABLE "REGISTRO"."INFOVISITA" DROP CONSTRAINT "FK_INFOVISITA_PERSONA_FK" CASCADE;

-- ALTER TABLE "REGISTRO"."INFOVISITA" DROP CONSTRAINT "FK_INFOVISITAV_RESERVACION" CASCADE;

-- ALTER TABLE "REGISTRO"."V_RESERVACION" DROP CONSTRAINT "FK_V_RESERVACIONV_CONTACTO1" CASCADE;

-- ALTER TABLE "REGISTRO"."V_RESERVACION" DROP CONSTRAINT "FK_V_RESERVACIONV_CONTACTO2" CASCADE;

-- ALTER TABLE "REGISTRO"."V_RESERVACION" DROP CONSTRAINT "FK_V_RESERVACIONV_GRUPOANON" CASCADE;

-- ALTER TABLE "REGISTRO"."V_RESERVACION" DROP CONSTRAINT "FK_V_RESERVACIONV_GRUPORSRV" CASCADE;

-- ALTER TABLE "REGISTRO"."PERSONA" DROP CONSTRAINT "FK_PERSONAV_INSTITUCION" CASCADE;

-- ALTER TABLE "REGISTRO"."PERSONA" DROP CONSTRAINT "FK_PERSONAV_PAISES" CASCADE;

-- ALTER TABLE "REGISTRO"."PERSONA" DROP CONSTRAINT "FK_V_PAISESPERSONA" CASCADE;

-- ALTER TABLE "REGISTRO"."V_INSTITUCION" DROP CONSTRAINT "FK_V_INSTITUCIONV_PAISES" CASCADE;
-- --------------------------------------------------
...
-- DROP TABLE "REGISTRO"."V_ESTACION";

-- DROP TABLE "REGISTRO"."V_RESERVACION";

-- DROP TABLE "REGISTRO"."INFOVISITA";

-- DROP TABLE "REGISTRO"."V_CONTACTO";

-- DROP TABLE "REGISTRO"."V_GRUPOANON";

-- DROP TABLE "REGISTRO"."V_GRUPORSRV";

-- DROP TABLE "REGISTRO"."V_INSTITUCION";
...
-- Creating foreign key on "ESTACION" in table 'V_RESERVACION'
ALTER TABLE "REGISTRO"."V_RESERVACION"
ADD CONSTRAINT "FK_V_RESERVACIONV_ESTACION"
...
-- Creating index for FOREIGN KEY 'FK_V_RESERVACIONV_ESTACION'
CREATE INDEX "IX_FK_V_RESERVACIONV_ESTACION"
ON "REGISTRO"."V_RESERVACION"
   ("ESTACION");
