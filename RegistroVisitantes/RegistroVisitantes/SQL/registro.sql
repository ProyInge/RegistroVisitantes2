...
--SELECT * FROM V_PAISES WHERE ISO = 'CR';
--UPDATE PERSONA SET NACIONALIDAD = 'CR' WHERE NACIONALIDAD NOT IN (SELECT ISO FROM V_PAISES);
--UPDATE PERSONA SET PAIS = 'CR' WHERE PAIS NOT IN (SELECT ISO FROM V_PAISES);
--UPDATE PERSONA SET PAIS = NACIONALIDAD WHERE PAIS IS NULL;
--UPDATE PERSONA SET NACIONALIDAD = PAIS WHERE NACIONALIDAD IS NULL;
--UPDATE PERSONA SET PAIS = 'US' WHERE INSTITUCION=5694 AND PAIS IS NULL;
--SELECT * FROM CONTACTOS.CONTACTO WHERE CONTACTO =	'CYCLO0505072013.080530481';
--SELECT * FROM INFOVISITA;
--SELECT * FROM PERSONA;
--SELECT * FROM PERSONA WHERE PAIS IS NULL OR NACIONALIDAD IS NULL;
--SELECT * FROM PERSONA WHERE ROL IS NULL;
--UPDATE PERSONA SET GENERO = 'M' WHERE GENERO = '0';
--UPDATE PERSONA SET GENERO = 'F' WHERE GENERO = '1';
--UPDATE PERSONA SET ROL = 'Otro' WHERE ROL IS NULL AND POSICION LIKE '%Ot%'
--SELECT COUNT(*) FROM PERSONA WHERE ROL IS NULL;
...
--DELETE FROM V_INSTITUCION WHERE COUNTRY IS NULL;
--SELECT * FROM V_INSTITUCION WHERE CAT_INSTITUCION =0;
...
--SELECT COUNT(*) FROM PERSONA WHERE INSTITUCION IS NULL;
--SELECT COUNT(*) FROM PERSONA WHERE INSTITUCION IN (SELECT CAT_INSTITUCION FROM CONTACTOS.CAT_INSTITUCION);
--SELECT * FROM PERSONA WHERE INSTITUCION NOT IN (SELECT CAT_INSTITUCION FROM CONTACTOS.CAT_INSTITUCION);
--SELECT * FROM REPORTE;
--ALTER TABLE INFOVISITA ADD( ESTADOC CHAR DEFAULT 'A' NOT NULL);
--UPDATE INFOVISITA SET ESTADOC = 'A' WHERE ESTADO = 1;
--UPDATE INFOVISITA SET ESTADOC = 'I' WHERE ESTADO = 0;
--ALTER TABLE INFOVISITA DROP COLUMN ESTADO;
--ALTER TABLE INFOVISITA RENAME COLUMN ESTADOC TO ESTADO;
