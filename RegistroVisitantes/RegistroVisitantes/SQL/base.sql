...
CREATE TABLE "USUARIO" (	
	...
	CONSTRAINT "USUARIO_ESTACION_FK" FOREIGN KEY (IDESTACION) REFERENCES ESTACION(ID)
);
/
...
INSERT INTO USUARIO (NOMBRE,APELLIDO,EMAIL,USUAR,CONTRASENA,ROL,IDESTACION) VALUES ('David','Solano','desolanom@gmail.com','dave','dave','R','SII014192819200.7082987519');
INSERT INTO USUARIO (NOMBRE,APELLIDO,EMAIL,USUAR,CONTRASENA,ROL,IDESTACION) VALUES ('Emmanuel','Arias','emma@gmail.com','emma','emma','R','SII014192819200.7082987519');
INSERT INTO USUARIO (NOMBRE,APELLIDO,EMAIL,USUAR,CONTRASENA,ROL,IDESTACION) VALUES ('Angélica','Fallas','ange@gmail.com','ange','ange','S','SII014192819200.7082987519');
INSERT INTO USUARIO (NOMBRE,APELLIDO,EMAIL,USUAR,CONTRASENA,ROL,IDESTACION) VALUES ('Daniel','Arias','daniel@gmail.com','daniel','daniel','S','SII014192819200.7082987519');
INSERT INTO USUARIO (NOMBRE,APELLIDO,EMAIL,USUAR,CONTRASENA,ROL,IDESTACION) VALUES ('Jeffry','Venegas','jeffry@gmail.com','jeffry','jeffry','A','SII014192819200.7082987519');
INSERT INTO USUARIO (NOMBRE,APELLIDO,EMAIL,USUAR,CONTRASENA,ROL,IDESTACION) VALUES ('Gabriel','Bermúdez','gabriel@g.com','gabriel','gabriel','R','SII014192819200.7082987519');
INSERT INTO USUARIO (NOMBRE,APELLIDO,EMAIL,USUAR,CONTRASENA,ROL,IDESTACION) VALUES ('Admin','Istrador','admin@gmail.com','admin','admin','A','SII014192819200.2788020223');
INSERT INTO USUARIO (NOMBRE,APELLIDO,EMAIL,USUAR,CONTRASENA,ROL,IDESTACION) VALUES ('Secre','Taria','secre@gmail.com','secre','secre','S','SII014192819200.7082987519');
INSERT INTO USUARIO (NOMBRE,APELLIDO,EMAIL,USUAR,CONTRASENA,ROL,IDESTACION) VALUES ('Root','Superusuario','root@gmail.com','root','root','R','SII014548761600.7018216447');
/
